        ...
        if self.mode == 'train':
            with open(sample_file_path, 'r') as f:
                for line in f:
                    ...
                    sample_image_path = os.path.join(self.dataset_root, items[0])
                    sample_label_path = os.path.join(self.dataset_root, items[1])
                    self.sample_list.append([sample_image_path, sample_label_path])
            f.close()
